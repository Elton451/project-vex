import type { Point, Segment } from "../types/Endpoint";

const leftOf = (segment: Segment, point: Point): boolean => {
  const cross =
...
const interpolate = (pointA: Point, pointB: Point, f: number): Point => {
  return {
